"""
Django settings for Task_Ass_v0_0_1 project.
...
SECRET_KEY = 'django-insecure-)oer@b6p*_^m$e-i=vuckobc=arx_+x^@sxh@03j)x6fr4@zu2'
...
WSGI_APPLICATION = 'Task_Ass_v0_0_1.wsgi.application'
